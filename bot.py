...
plunder_ui_elements = {"elements": [{"image" : plunder_button, "threshold" : 0.90, "callback" : keyinput.click},
                                    ...
                                    {"image" : x1_button, "threshold" : 0.80, "callback" : keyinput.click},
                                    {"image" : x2_button, "threshold" : 0.80, "callback" : keyinput.click},
                                    {"image" : x3_button, "threshold" : 0.80, "callback" : keyinput.click},
                                    {"image" : x4_button, "threshold" : 0.80, "callback" : keyinput.click},
